...
export type Database = {
	...
	public: {
		...
		Functions: {
			archive_test: { Args: { p_test_id: string }; Returns: Json };
			duplicate_test: {
		...
		Enums: {
			channel_type: 'direct' | 'search' | 'social' | 'email' | 'external' | 'other';
			conversion_type: 'none' | 'signup' | 'test_start' | 'test_complete' | 'other';
			device_type: 'mobile' | 'desktop' | 'tablet';
			feedback_category: 'bug' | 'feature' | 'ui' | 'etc';
			feedback_status: 'new' | 'in_progress' | 'resolved' | 'rejected';
			funnel_step: 'visit' | 'signup' | 'test_start' | 'test_complete' | 'revisit';
			question_type: 'single_choice' | 'multiple_choice' | 'short_answer';
			result_condition_type: 'score_range' | 'choice_ratio' | 'quiz_score' | 'custom';
