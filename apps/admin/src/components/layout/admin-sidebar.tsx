...
function NavSectionComponent({
  ...
  return (
    <div className="px-3 py-2 text-xs uppercase text-neutral-500 tracking-wide font-medium">
      {name}
    </div>
  );
}
...
function NavItemComponent({
  ...
  return (
    ...
    >
      <div className="w-4 mr-3 text-neutral-600 flex items-center justify-center">
        {entry.icon}
      </div>
      {!isCollapsed && (
